...
if(isset($submit))
{
	$rs=mysqli_query($conn,"select * from mst_user where email='$loginid' and pass='$pass'");
                ...
                <div class="p-5">
                  <div class="text-center">
					...
					<form class="user" method="post" action="" id="user_section"> 
						<div class="form-group">
						  <input type="text" class="form-control form-control-user" name="loginid"  placeholder="Enter Loginid..." value="">
						</div>
						<div class="form-group">
						  <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="pass" placeholder="Password" value="">
						</div>
                  ...
                  <hr>
				    <div class="row">
						...
						<div class="col-md-6">
							<button type="button" class="btn btn-success btn-block" id="user">Citizen</button>
						</div>
					</div>	
                  <!--<div class="text-center">
